  ...
  return (
    <Modal title="Harvest In" onDismiss={onDismiss}>
      ...
      <Flex justifyContent="center">
        <Text bold color="textDisabled">{TranslateString(348, 'Pool')}: {pool}</Text>
      </Flex>
      <Flex justifyContent="center">
        <Text bold color="textDisabled">{TranslateString(10012, 'Harvest Lockup')}: {harvestLockup} {TranslateString(10014, 'Hour(s)')}</Text>
      </Flex>
    </Modal>
  )
}
